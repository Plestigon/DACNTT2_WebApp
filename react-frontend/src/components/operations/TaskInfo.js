    ...
    <div class="content mt-5">
        ...
        <Container>
            ...
            <Row style={{marginLeft: '10%', marginRight: '10%'}}>
                <Col>
                    <label class="w-100">
                    Asigned To:<input name="owner" class="form-control" value={data.ownerName} disabled/>
                    </label>
                </Col>
                <Col>
                State:<Select options={options} value={{label: data.statusName, value: data.status}} onChange={handleInputChange}/>
                </Col>
                <Col>
                Due Date:
